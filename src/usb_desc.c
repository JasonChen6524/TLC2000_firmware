...
const uint8_t CustomHID_ConfigDescriptor[CUSTOMHID_SIZ_CONFIG_DESC] =
  {
    ...
    MAX_TRANSFER_LEN,          /* wMaxPacketSize: 2 Bytes max */                      // Jason Chen
    0x00,
...
#else
    0x01,	/* bEndpointAddress: */             // EP1
#endif
			/*	Endpoint Address (OUT) */
    0x03,	/* bmAttributes: Interrupt endpoint */
    MAX_TRANSFER_LEN,	/* wMaxPacketSize: 2 Bytes max  */
    0x00,
...
//    0x06, 0x00, 0xFF,                      // Usage Page
    ...
    0x95, MAX_TRANSFER_LEN-1,                // Report Count
    0x81, 0x02,                              // Input
    ...
    0x95, MAX_TRANSFER_LEN-1,  /*     REPORT_COUNT (4)           */        //4 + 1 bytes
...
const uint8_t CustomHID_StringProduct[CUSTOMHID_SIZ_STRING_PRODUCT] =
  ...
  //'S', 0, 'T', 0, 'M', 0, '3', 0, '2', 0, ' ', 0, 'C', 0,
		'T', 0, 'h', 0, 'e', 0, 'r', 0, 'a', 0, 'L', 0, 'a', 0, 's', 0, 'e', 0, ' ', 0, 'C', 0,
