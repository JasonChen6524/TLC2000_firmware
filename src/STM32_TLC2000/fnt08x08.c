...
unsigned char Font_char[117][8]=
  {{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, //  32 = 0x20 = " "
   ...
   {0x00,0x00,0x41,0x22,0x14,0x08,0x00,0x00}, // 128=0x80=i01="Arrow"
   {0x7F,0x41,0x41,0x41,0x41,0x41,0x7F,0x00}, // 129=0x81=i02="Box"
   {0x7F,0x41,0x41,0x63,0x55,0x49,0x7F,0x00}, // 130=0x82=i03="Arrow in a Box"
   {0x20,0x40,0x46,0x49,0x49,0x31,0x02,0x00}, // 131=0x83=i04="italic S"
   {0x40,0x30,0x0C,0x0B,0x09,0x01,0x01,0x00}, // 132=0x84=i05="italic F"
   {0x08,0x1C,0x36,0x6B,0x1C,0x36,0x63,0x00}, // 133=0x85=i06="<<"
   {0x63,0x36,0x1C,0x6B,0x36,0x1C,0x08,0x00}, // 134=0x86=i07=">>"
   {0x00,0x0C,0x06,0x7F,0x7f,0x06,0x0C,0x00}, // 135=0x87=i08="up arrow"
   {0x00,0x18,0x30,0x7F,0x7F,0x30,0x18,0x00}, // 136=0x88=i09="down arrow"
   {0x30,0x60,0xC0,0x78,0x0E,0x03,0x01,0x00}, // 137=0x89=i10="check"
   {0xC0,0x70,0x3E,0x1B,0x11,0x18,0x0C,0x00}, // 138=0x8A=i11="wrench (still kinda)"
   {0x18,0x3C,0x7E,0x5A,0x18,0x18,0x18,0x00}, // 139=0x8B=i12="left arrow"
   {0x18,0x18,0x18,0x5A,0x7E,0x3C,0x18,0x00}, // 140=0x8C=i13="right arrow"
   {0x3C,0x42,0x40,0x5F,0x40,0x42,0x3C,0x00}, // 141=0x8D=i14="power"
   {0x7F,0x3E,0x1C,0x08,0x00,0x7F,0x7F,0x00}, // 142=0x8E=i15="run stop"
   {0x61,0x63,0x67,0x6F,0x67,0x63,0x61,0x00}, // 143=0x8F=i16="reset"
   {0x22,0x39,0x3C,0x7E,0x3C,0x39,0x22,0x00}, // 144=0x90=i17="bell"
   {0x38,0x54,0x54,0x08,0x02,0x02,0x02,0x00}, // 145=0x8F=i18="e and minus"
   {0x38,0x54,0x54,0x08,0x02,0x07,0x02,0x00}, // 146=0x8F=i19="e and plus"
   {0x00,0x7F,0x3E,0x1C,0x08,0x00,0x00,0x00}, // 147=0x8E=i20="run only"
   {0x00,0x7F,0x7F,0x7F,0x7F,0x00,0x00,0x00}};// 148=0x8E=i21="stop only"
//============================================================================
